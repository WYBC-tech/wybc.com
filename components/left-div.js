...
class LeftDiv extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
            ...
            <!--Weather widget-->
            <div class="box">
                <a class="weatherwidget-io" href="https://forecast7.com/en/41d31n72d93/new-haven/?unit=us" data-label_1="NEW HAVEN" data-label_2="WEATHER" data-font="Verdana" data-mode="Current" data-theme="kiwi" >NEW HAVEN, CT</a>
                <script>
